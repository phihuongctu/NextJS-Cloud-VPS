...
export default function Sidebar() {
  ...
  return (
    <aside
      ...
      } hidden overflow-y-auto h-screen w-full fixed top-0 left-0 right-0 z-20 bg-white lg:flex lg:flex-col  lg:z-10 lg:sticky lg:max-w-xs lg:shadow-md  `}
    >
      <div className={`${sidebar ? "bg-white" : ""} sticky top-0 z-1`}>
        <div
          className={`${
        ...
        >
          <a className="flex">
            <div
              className={`${
                sidebar ? " mr-4" : ""
              } flex items-center font text-base`}
            >
              {sidebar ? (
                <svg
                  width="40"
                ...
                >
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <stop offset="0.991398" stopColor="#00C0FF" />
                    </linearGradient>
                    <linearGradient
                      id="paint1_linear"
                      x1="22.0498"
          ...
          <div onClick={showSidebar} className="nav-icon cursor-pointer">
            {sidebar ? (
              <Image
                src="/img/toggle.svg"
                width="24"
        ...
        <div
          className={` ${
            sidebar
              ? "px-4 pt-4 pb-2"
              : "h-12 w-12 p-0 m-auto rounded-lg group hover:bg-blue-50"
          } relative flex w-full flex-wrap items-center `}
        >
          <span
            className={` ${
              sidebar ? "w-8 pl-3 py-3" : " flex h-12 w-12 p-0 "
            } z-10 leading-snug font-normal absolute text-center text-blueGray-300  bg-transparent text-base items-center justify-center `}
          >
            <svg
              width="20"
              height="20"
          ...
          <input
            ...
            className={` ${
              sidebar ? "" : "hidden"
            } px-3 py-4 placeholder-blueGray-300 text-gray-600 relative bg-gray-100 outline-none rounded-lg text-sm border-transparent focus:ring-1 focus:ring-blue-600 focus-visible: w-full pl-10`}
          />
        </div>
      </div>
      <ul id="slide-menu" className=" px-4 menu slide-menu flex-1">
                ...
                {typeof items.path !== "undefined" ? (
                  <Link href={items.path} scroll={false}>
                    <a
                      ...
                      } group hover:bg-blue-50 rounded-lg flex items-center mt-2 justify-start text-gray-500 cursor-pointer font-semibold text-base`}
                    >
                      <Image
                        src={items.icon}
                        width="24"
                      ...
                      <li key={index} className={sidebar ? "" : "hidden"}>
                        {typeof child.path !== "undefined" ? (
                          <Link href={child.path}>
                            <a className=" p-3.5 group hover:bg-blue-50 rounded-lg flex items-center mt-2 justify-start text-gray-500 cursor-pointer text-base font-semibold ">
                              <Image
                                src={child.icon}
                                width="24"
                                height="24"
      ...
      <div
        className={`${
          sidebar ? "bg-white" : ""
        } log-out sticky bottom-0  pb-4 w-full `}
      >
        <Theme sidebar={sidebar} setSidebar={setSidebar} />
        <a
          className={` ${
            sidebar
              ? "bg-gradient-to-r from-blue-800 via-blue-600 to-blue-400 m-auto p-4"
